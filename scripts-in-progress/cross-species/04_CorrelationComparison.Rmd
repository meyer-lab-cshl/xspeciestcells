...
ortholog.df <- read.csv("~/Projects/HumanThymusProject/data/03_BiomartTable/big_ass_ortholog_table.csv")
ortholog.gapin <- read.csv("~/Projects/HumanThymusProject/data/03_BiomartTable/Cleaned_gene_correspondance_Human_Mouse.csv")
```
