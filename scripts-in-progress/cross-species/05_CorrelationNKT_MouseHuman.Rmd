---
title: "05_CorrelationNKT_MouseHuman"
...
seur.mouse <- readRDS("~/Projects/HumanThymusProject/data/00_Reproduce_UMAPs/ms_seurobj.rds")
seur.human <- readRDS("~/Projects/HumanThymusProject/data/raw_data/human_data/filtered_seurat_Harmony_07-22-22.RDS")

# Sanity check
print(seur.mouse) # 10817 cells
...
# path <- "~/Projects/HumanThymusProject/data/cross-species/02_CorrelationComparion"
# # Mouse data
...
NKT_Thymus_samples <- RunHarmony(NKT_Thymus_samples,
                                 ...
                                 assay.use = "SCT",
                                 max.iter.harmony = 20)
# NKT_Thymus_samples <- RunPCA(NKT_Thymus_samples, assay="SCT")
NKT_Thymus_samples <- RunUMAP(NKT_Thymus_samples, dims = 1:15, assay="SCT", reduction="harmony")
NKT_Thymus_samples <- FindNeighbors(NKT_Thymus_samples, dims = 1:15, assay="SCT", reduction="harmony")
NKT_Thymus_samples <- FindClusters(NKT_Thymus_samples, resolution = 0.7, assay="SCT")
