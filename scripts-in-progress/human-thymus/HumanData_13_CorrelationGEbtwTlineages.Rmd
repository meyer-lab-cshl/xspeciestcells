...
plotHeatmap <- function(values, clust=F, pval=T, colscalerange=c(0.5,1), plottitle, hclust.method="ward.D", diag=F){
  ...
  corrplot(values$corr,
     ...
     colors=colorRampPalette(c("#ffffcc", "#fd8d3c","#fc4e2a", "#e31a1c", "#bd0026","#800026"))(200),
...
# jpeg(file.path(path.plot, "int2000hvgs-thym-hvg_corrheatmap2.jpeg"), width=2200, height=2200, res=300)
