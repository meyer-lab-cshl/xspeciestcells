...
seur <- readRDS("~/Projects/HumanThymusProject/data/raw_data/human_data/seurat_filtered_harmony_08_28_23.RDS") # removed low-quality cells
...
park_metadata <- read.csv("~/Projects/HumanThymusProject/data/human-thymus/HumanData_16_ParkIntegration/park_metadata_thymocyte.csv")
...
# ggsave("~/Projects/HumanThymusProject/data/human-thymus/HumanData_16_ParkIntegration/park_umap_with_legend.pdf", width=12, height=9)
...
seur.thymus@meta.data$new_clusters <- as.character(seur.thymus@meta.data$new_clusters)
seur.thymus@meta.data$new_clusters <- factor(seur.thymus@meta.data$new_clusters, levels=0:17)
...
ggrastr::rasterise(
  SCpubr::do_DimPlot(seur.thymus, 
                   ...
                   colors.use=cols_integrated),
  layers="Point", dpi=300)
ggsave("~/Projects/HumanThymusProject/data/human-thymus/HumanData_16_ParkIntegration/gapin_umap_thymus.pdf", width=10, height=10)
