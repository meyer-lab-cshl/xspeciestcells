...
ggplot(
  ...
  geom_point()+
  facet_wrap(~factor(tcell_lineage, levels=c("iNKT", "MAIT", "GD")))+
  scale_color_manual(values=c(cols_thym_nkt, cols_thym_mait, cols_thym_gdt))+
  labs(x="Type 1 signature", y="Type 17 signature")+
  theme_cowplot()
# ggsave("./scripts-in-progress/human-thymus/HumanThymus_26_coexpression_type1_type17/plots/scatterplot_coexpression_allcells.pdf", width=10, height=5)
```
...
PlotCoexpression(
  ...
  cols.neg="#d9d9d9", # negative color
  cols.pos=c("red", "blue"),
