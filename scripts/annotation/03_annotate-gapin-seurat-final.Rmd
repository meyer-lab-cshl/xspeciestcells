...
seur.gapin <- readRDS("data/human-thymus/annotation/seurat_filtered_harmony_02_15_23_thymus_subset_annotations.RDS")
...
```{R}
# Gapin data
gapin_columns_to_keep <- colnames(seur.gapin@meta.data)[c(1:32,76)]
...
saveRDS(seur.gapin, 'data/human-thymus/annotation/gapin_full_seu_gene_names_updated_anno.rds')
```