...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/07_scClustEval/thymic_nkt/lowest_highest_cluster_nb2.jpeg", width=15, height=5)
```
...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/07_scClustEval/thymic_nkt/nkt_subsampling_stableclusters1.jpeg", width=7, height=5)
...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/07_scClustEval/thymic_nkt/nkt_subsampling_stableclusters2.jpeg", width=6, height=5)
...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/07_scClustEval/thymic_nkt/nkt_subsampling_pc10-res07-k20.jpeg", width=15, height=5)
...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/07_scClustEval/thymic_nkt/nkt_pc15-res07-k50.jpeg", width=17, height=5)
...
```{r import-data-mait}
# Import data
mait.seur <- readRDS("../../data/07_scClustEval/input/mait_object_22-11-10.rds")
mait.subsampling  <- readRDS("../../data/07_scClustEval/thymic_mait/gather_subsample.rds")
mait.fullsample <- readRDS("../../data/07_scClustEval/thymic_mait/gather_full_sample.rds")
...
ParameterSetScatterPlot(stable_clusters = mait.stableClust,
                        ...
                        facet_rows = "resolution",
                        facet_cols = "pc") + ggtitle("stable cluster if jaccard_median > 0.6")
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/07_scClustEval/thymic_mait/mait_subsampling_stableclusters1_2.jpeg", width=7, height=7)
...
ParameterSetScatterPlot(stable_clusters = mait.stableClust,
                        ...
                        facet_cols = "pc") +
  ggtitle("% of cells in stable clusters")
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/07_scClustEval/thymic_mait/mait_subsampling_stableclusters2_2.jpeg", width=6, height=7)
...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/07_scClustEval/thymic_mait/mait_subsampling_pc10-res02-k30.jpeg", width=15, height=5)
...
```{r import-data-gdt}
# Import data
gdt.seur <- readRDS("../../data/07_scClustEval/input/gdt_object_22-11-10.rds")
gdt.subsampling  <- readRDS("../../data/07_scClustEval/thymic_gdt/gather_subsample.rds")
gdt.fullsample <- readRDS("../../data/07_scClustEval/thymic_gdt/gather_full_sample.rds")
...
ParameterSetScatterPlot(stable_clusters = gdt.stableClust,
                        ...
                        facet_rows = "resolution",
                        facet_cols = "pc") + ggtitle("stable cluster if jaccard_median > 0.6")
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/07_scClustEval/thymic_gdt/gdt_subsampling_stableclusters1.jpeg", width=7, height=5)
...
ParameterSetScatterPlot(stable_clusters = gdt.stableClust,
                        ...
                        facet_cols = "pc") +
  ggtitle("% of cells in stable clusters")
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/07_scClustEval/thymic_gdt/gdt_subsampling_stableclusters2.jpeg", width=6, height=5)
...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/07_scClustEval/thymic_gdt/gdt_subsampling_pc15-res04-k20.jpeg", width=15, height=5)
...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/07_scClustEval/thymic_gdt/gdt_subsampling_pc20-res04-k10.jpeg", width=15, height=5)
...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/07_scClustEval/thymic_gdt/gdt_subsampling_pc20-res1-k20.jpeg", width=15, height=5)
