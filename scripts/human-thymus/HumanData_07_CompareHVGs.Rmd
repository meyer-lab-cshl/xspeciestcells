...
# seur.human.sct <- readRDS("~/Projects/HumanThymusProject/data/raw_data/human_data/filtered_seurat_Harmony_07-22-22.RDS")
...
library(VennDiagram)
library(RColorBrewer)
path.plots <- "~/Projects/HumanThymusProject/data/human-thymus/HumanData_07_CompareHVGs"
...
```{r highlight-hvg-on-expression-plot, width=10}
# MAIT vs integrated
...
# ggsave("~/Projects/HumanThymusProject/data/human-thymus/HumanData_07_CompareHVGs/mait-specific-HVG_BLKexample.jpeg", width=10, height=5)
...
# ggsave("~/Projects/HumanThymusProject/data/human-thymus/HumanData_07_CompareHVGs/integrated-specific-HVG_JCHAINexample.jpeg", width=10, height=5)
```
