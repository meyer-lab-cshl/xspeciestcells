...
## 5. INTEGRATION HARMONY PIPELINE (sctransform)
...
### 5.1. Normalize with SCTransform
...
# select features that are repeatedly variable across datasets for integration
sct.hvg  <- SelectIntegrationFeatures(object.list = seur.list, nfeatures = 5000)
VariableFeatures(seur.SCT) <- sct.hvg
```

### 5.2. Perform integration with Harmony
...
### 5.3. Clustering & Dimension reduction
...
seur.sct_harmony@meta.data$seurat_clusters <- case_when(
  ...
  seur.sct_harmony@meta.data$SCT_snn_res.0.7 == 2 ~ 16,
  seur.sct_harmony@meta.data$SCT_snn_res.0.7 == 3 ~ 5,
  seur.sct_harmony@meta.data$SCT_snn_res.0.7 == 4 ~ 14,
  seur.sct_harmony@meta.data$SCT_snn_res.0.7 == 5 ~ 4,
  seur.sct_harmony@meta.data$SCT_snn_res.0.7 == 6 ~ 15,
  seur.sct_harmony@meta.data$SCT_snn_res.0.7 == 7 ~ 13,
  seur.sct_harmony@meta.data$SCT_snn_res.0.7 == 8 ~ 3,
  seur.sct_harmony@meta.data$SCT_snn_res.0.7 == 9 ~ 12,
  seur.sct_harmony@meta.data$SCT_snn_res.0.7 == 10 ~ 2,
  seur.sct_harmony@meta.data$SCT_snn_res.0.7 == 11 ~ 9,
  seur.sct_harmony@meta.data$SCT_snn_res.0.7 == 12 ~ 7,
  seur.sct_harmony@meta.data$SCT_snn_res.0.7 == 13 ~ 0,
  seur.sct_harmony@meta.data$SCT_snn_res.0.7 == 14 ~ 1,
  seur.sct_harmony@meta.data$SCT_snn_res.0.7 == 15 ~ 17,
  seur.sct_harmony@meta.data$SCT_snn_res.0.7 == 16 ~ 6,
  seur.sct_harmony@meta.data$SCT_snn_res.0.7 == 17 ~ 8
)
...
# Visualization
DimPlot(seur.sct_harmony, reduction = "umap", group.by = "Batch")
...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/06_HumanData/preprocessing/sct-harmony_comparisonClustersLaurent.jpeg", width=10, height=10)
...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/06_HumanData/preprocessing/sct-harmony_comparisonUMAPs.jpeg", width=12, height=6)
```

### 5.5. Quick try to reproduce Laurent's initial seurat object
...
# Preprocessing
seur.rep <- SCTransform(initseur, assay="RNA", vars.to.regress = 'percent.mt', verbose=T)
...
seur.rep@meta.data$seurat_clusters <- case_when(
  seur.rep@meta.data$SCT_snn_res.1 == 0 ~ 11,
  seur.rep@meta.data$SCT_snn_res.1 == 1 ~ 10,
  seur.rep@meta.data$SCT_snn_res.1 == 2 ~ 14,
  seur.rep@meta.data$SCT_snn_res.1 == 3 ~ 15,
  seur.rep@meta.data$SCT_snn_res.1 == 4 ~ 5,
  seur.rep@meta.data$SCT_snn_res.1 == 5 ~ 12,
  seur.rep@meta.data$SCT_snn_res.1 == 6 ~ 8,
  seur.rep@meta.data$SCT_snn_res.1 == 7 ~ 16,
  seur.rep@meta.data$SCT_snn_res.1 == 8 ~ 7,
  seur.rep@meta.data$SCT_snn_res.1 == 9 ~ 13,
  seur.rep@meta.data$SCT_snn_res.1 == 10 ~ 9,
  seur.rep@meta.data$SCT_snn_res.1 == 11 ~ 4,
  seur.rep@meta.data$SCT_snn_res.1 == 12 ~ 3,
  seur.rep@meta.data$SCT_snn_res.1 == 13 ~ 0,
  seur.rep@meta.data$SCT_snn_res.1 == 14 ~ 6,
  seur.rep@meta.data$SCT_snn_res.1 == 15 ~ 1,
  seur.rep@meta.data$SCT_snn_res.1 == 16 ~ 2
)
...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/06_HumanData/preprocessing/sct-merged-harmony_comparisonClustersLaurent.jpeg", width=10, height=10)
...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/06_HumanData/preprocessing/sct-merged-harmony_comparisonUMAPs.jpeg", width=12, height=6)
```
