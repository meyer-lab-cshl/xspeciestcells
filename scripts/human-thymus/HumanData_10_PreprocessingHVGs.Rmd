...
# length(hvg.thymicells) # 3204 HVGs (n=1000); 5862 HVGs (n=2000)
# table(hvg.thymicells %in% VariableFeatures(seur.norm2), useNA="ifany") # 1806 (or 4147) are not in the 2000 global HVGs
...
length(hvg.thymicells) # sanity check: 3204 HVGs (n=1000); 5862 HVGs (n=2000)
...
# Cell type composition per cluster
ggplot(seur.harmony3@meta.data[,c("cell.ident", "seurat_clusters")] %>% group_by(cell.ident, seurat_clusters) %>% count(),
       aes(x=seurat_clusters, y=n, fill=cell.ident))+
  geom_bar(position="fill", stat="identity") +
  scale_fill_manual(values=brewer.pal(7,"Paired")) +
...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/06_HumanData/HVGs/umap_with_thymic_hvg.jpeg", width=24, height=6)
...
flowplot()
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/06_HumanData/HVGs/umap_with_thymic_hvg3.jpeg", width=15, height=10)
...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/06_HumanData/HVGs/umap_with_thymic_hvg2.jpeg", width=24, height=6)
...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/06_HumanData/HVGs/umap_with_thymic_hvg4.jpeg", width=24, height=6)
```
...
# ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/06_HumanData/HVGs/umap_with_thymic_hvg_clus6.jpeg", width=15, height=10)
...
# ggsave("~/Desktop/umap_clus6.jpeg", width=24, height=6)

# Check out marker genes of cluster 10 in seur.harmony
