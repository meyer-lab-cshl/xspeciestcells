...
seur.tcr.in <- AddModuleScore(seur.tcr.in, features=list(tcrlist1), name="tcr_score")
seur.tcr.in <- FindVariableFeatures(seur.tcr.in, selection.method="vst", nfeatures=2000)
seur.tcr.in <- ScaleData(seur.tcr.in)
seur.tcr.in <- RunPCA(seur.tcr.in, features = tcrlist1, npcs=50, verbose=FALSE)
...
seur.tcr.outest <- RunPCA(seur.tcr.out, features = tcrlist1, npcs=50, verbose=FALSE)
