...
# # col_text <- col_text[corrMatOrder(Corr.Coeff.Table, order="hclust", hclust.method="ward.D")]
# 
# # Plot
# jpeg("~/Projects/HumanThymusProject/data/human-thymus/HumanData_12_CorrelationGEbtwTlineages/corr_heatmap_ordered_commonHVG.jpeg", width=2200, height=2200, res=300)
...
#          
#          # Text & title
#          main="Correlation on 230 HVGs (HVGs common to all lineages)",
#          tl.col=col_text, # text color
#          tl.pos="lt", # position labels on left & top
#          tl.cex=0.7, # size text label
#          
