...
seur.harmony <- RunHarmony(object = seur.SCT,
                           ...
                           plot_convergence = F) # converged after 2 iterations
...
DimPlot(seur.harmony, split.by = "dataset", group.by = "cell_state", pt.size = 0.1, label = TRUE, ncol=2, repel=T) +
  ggtitle("Harmony dataset+replicate | 20 PCs | No Rb-Mt genes") +
  theme_bw()+
  scale_color_manual(values=c("#a6cee3", "#1f78b4", "#b2df8a", "#33a02c",
                              ...
                              "#66a61e",
                              "#cab2d6"))
ggsave("~/Projects/20220809_Thymic-iNKT-CrossSpecies/data/00_MouseIntegration/harmony_20PCs_noRbMt.jpeg", width=10, height=5)
```

```{r SCTransform-Harmony-plot}
table(seur.harmony@meta.data$cell_type, useNA="ifany")
